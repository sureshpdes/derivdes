...
class AppController extends Controller
{
	...
	public $backup_interval = ['Once a day' => 'Once a day', 'Weekly' => 'Weekly', 'Monthly' => 'Monthly'];
	...
	public function beforeFilter(Event $event)
	{
		//exit();
			...
			$this->Security->setConfig('unlockedActions', ['fetchRelatedData', 'uploadPdf', 'dublicatePdf', 'deletePdf', 'findRelatedTemplate']);
    ...
    public function beforeRender(Event $event)
    {
		...
		$this->set('backup_interval', $this->backup_interval);
