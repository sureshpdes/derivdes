                        ...
                        if(val!='')
                        {
                            ...
                            field_html+='<div class="row align-items-center">';
                                ...
                                field_html+='<div class="col-md-6 d-flex gap-1">';
                                    ...
                                    field_html+='<input class="form-control '+validation_val+'" type="text" name="field_value[]" data-errormessage-value-missing="'+val.field_name+' is required">';
                                field_html+='</div>';
                            field_html+='</div>';
                        }
                    });
                    ...
                    <div class="pdfentry-sec-left">
                        ...
                        <div class="pdfentry-sec-left-btm-sec">
                            ...
                            <div class="text-end">
                                ...
                                <button class="btn btn-success mt-3" id="ongoing">Save &amp; Publish</button>
                        ...
                        <div class="pdfentry-sec-left-top">
                            <div class="row mx-0 align-items-center">
                                ...
                                <div class="col-md-3 px-0 ">
                                    ...
                                    <input type="submit" value="Delete" name="delete" class="mt-3">
                                </div>
                            </div>
                        </div>
                    </div>
                    <object width="100%" height="500" type="application/pdf" data="" id="pdf_content">
...
$(function(){
    ...
    $(".pdf_list").change(function(){
        ...
        if(pdf_path!='')
        {
            $("#pdf_content").attr('data',pdf_path+'/'+pdf_name);
        }
    });
