<?php
$this->assign('title', "FTP configuration Add");
?>
    ...
    <div class="row mx-0  g-0 mt-lg-0 mt-5">
        <div class="col-xl-6  col-lg-7 offset-lg-2 offset-xl-3">
            <div class="form-container">
                ...
                <?php echo $this->Form->create($FtpManagement, ['id' => 'add_form', 'type' => 'file']) ?>
                    <div class="form-wrap">
                        ...
                        <div class="form-group row mx-0 ">
                            ...
                            <div class="col-sm-9">
                                <?php echo $this->Form->control('description', ['autocomplete' => 'off', 'class' => 'form-control form-style validate[required] pass', 'data-errormessage-value-missing'=>'Description is required', 'label'=>false, 'required'=>false, 'div'=>false, 'placeholder'=>'Description', 'maxlength'=>255]);?>
                            </div>
                        </div>
                    </div>
