                    ...
                    <div class=" col-md-5 col-lg-4">
                        <div class="templatereset-left">
                            <div class="templatereset-dropdown">
                                ...
                                <input type="hidden" name="action_name" value="templateReset" id="action_name">
                                <div class="text-end">
...
$(function(){
    ...
    $(".reset_all").click(function(){
        if($(".entry_arr").val())
        {
            if (!confirm('Resetting will result in removal of all entry data associated with this template (except publihed docs) and the docs will be freashly available at Operator Level')){
                return false;
            } 
            else
            {
