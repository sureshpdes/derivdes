 ...
 */
class TemplateMaster extends Entity
{
    ...
    protected $_accessible = [
        'exchange_master_id' => true,
        'template_master_name' => true,
        'template_master_desc' => true,
        'template_master_status' => true,
    ];
