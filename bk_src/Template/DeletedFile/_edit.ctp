        ...
        <div class="pdfentry-body">
            ...
            <div class="row mx-0">
                            ...
                            <div class="pdfentry-sec-left-btm">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6 d-flex gap-1">
                                        ...
                                        <input class="form-control <?php echo $field->is_mand=='true' ? 'validate[required]' : '';?>" type="text" name="field_value[]" data-errormessage-value-missing="<?php echo $field->field_name ?> is required" value="<?php echo $edit_field_val?>">
                                    </div>
                                </div>
                                <?php
                                    endforeach;
                ...
                <div class="col-md-7">
                    ...
                    <object width="100%" height="500" type="application/pdf" data="<?php echo $this->Url->build('/'.$pdfdump_folder.'/'.$entry->primary_pdf_name)?>" id="pdf_content">
